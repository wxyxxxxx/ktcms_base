...
//var_dump(config('err_msg'));
    ...
    if(config('err_msg')=='json'){
        $err="位置：".sprintf('%s in %s', parse_class($name), parse_file($file, $line))."<br>内容：".nl2br(htmlentities($message));
        echo json_encode(['code'=>-1,'msg'=>$err]);exit;
    }
?>
<!DOCTYPE html>
<html>
