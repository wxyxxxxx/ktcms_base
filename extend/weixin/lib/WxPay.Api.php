...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetAppid(cache("sh_appid"));//公众账号ID
		$inputObj->SetMch_id(cache("sh_mchid"));//商户号
	...
	{		
		...
		if($useCert == true){
			...
			curl_setopt($ch,CURLOPT_SSLCERT, cache("sh_sslcert_path"));
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
			curl_setopt($ch,CURLOPT_SSLKEY, cache("sh_sslkey_path"));
		}
		//post提交方式
