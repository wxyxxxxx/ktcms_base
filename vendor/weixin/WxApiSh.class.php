...
class WxApiSh {
	...
	public function wxHttpsRequestPem($url, $vars, $second = 30, $aHeader = array()) {
		...
		curl_setopt($ch, CURLOPT_SSLCERT, "/data/wwwroot/default/vendor/weixin/cert/apiclient_cert.pem");
		//默认格式为PEM，可以注释
		curl_setopt($ch, CURLOPT_SSLKEYTYPE, 'PEM');
		curl_setopt($ch, CURLOPT_SSLKEY, "/data/wwwroot/default/vendor/weixin/cert/apiclient_key.pem");

		curl_setopt($ch, CURLOPT_CAINFO, 'PEM');
		curl_setopt($ch, CURLOPT_CAINFO, "/data/wwwroot/default/vendor/weixin/cert/rootca.pem");
	...
	public function weixin_jsapi_ticket() {
		...
		return ROOT_PATH . 'weixin/js_ticket_sh.json';
	}
	public function weixin_access_token() {
		//echo "ROOT_PATH.'/Public/cache/js_ticket.json'";exit;
		return ROOT_PATH . 'weixin/access_token_sh.json';
	}
	/****************************************************
